        ...
        <div class="flex">
            <nav class="w-56 h-screen shadow-lg bg-gray-100 dark:bg-slate-900 dark:text-white">
                ...
                <ul class="mt-8">
                    ...
                    <li>
                        <a href="{{route('bus-route.index')}}" class="block hover:bg-gray-200 p-4 rounded-lg font-bold text-xl ">Bus-Route</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="" class="block hover:bg-gray-200 p-4 rounded-lg font-bold text-xl">Users</a>
                    </li>
                    <li>
